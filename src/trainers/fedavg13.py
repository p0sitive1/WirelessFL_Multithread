###########################################
##  Benchmark : Statistical Sampling
###########################################
...
class FedAvg13Trainer(BaseTrainer):
    def __init__(self, options, trainerConfig):
        ...
        super(FedAvg13Trainer, self).__init__(options, trainerConfig)
    ...
    def compute_grad_prob(self):  
        ...
        if self.is_sys_heter:
            ...
            pk_mul_gk = pks*gks
            probs = pk_mul_gk / np.sum(pk_mul_gk)
