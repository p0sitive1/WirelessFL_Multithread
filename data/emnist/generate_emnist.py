...
def main():
    ...
    # num_samples = np.random.uniform(50, 150, (NUM_USER))
    ...
    for user in range(NUM_USER):
        ...
        #     elif num_samples[user] > 10000:
        #         num_class = np.random.randint(b-1,b+1)
        #     else:
        #         num_class = np.random.randint(a,b)
